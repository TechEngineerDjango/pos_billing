// Global country dial-code list for POS customer entry.
// Each entry: { code: ISO-3166 alpha-2, name, dial: numeric dial code (no +), flag: emoji }
...
// Reusable Alpine component for the country dial-code dropdown.
// getValue/setValue let the picker read/write a dial-code field that lives
// in the including page's own Alpine state, so the picker has no state of its own.
document.addEventListener('alpine:init', () => {
    Alpine.data('countryPicker', (getValue, setValue) => ({
        open: false,
        search: '',
        list: window.COUNTRY_CODES || [],
        get filtered() {
        ...
        get selected() {
            return this.list.find(c => c.dial === getValue()) || null;
        },
        get value() {
            return getValue();
        },
